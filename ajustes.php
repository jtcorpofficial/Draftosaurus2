...
<head>
  ...
  .toast-hide{ opacity: 0; transition: opacity .35s ease; }
  ...
  .jungle-header .btn.btn-volver:hover{
    background-color: #efe7c8 !important;
    color: #3d291c !important;
    transform: translateY(-2px);
    box-shadow: 0 6px 16px rgba(0,0,0,.2);
  }
  .jungle-header .btn.btn-volver:focus{
    outline: 3px solid rgba(78,52,34,.35);
    outline-offset: 2px;
  }
</style>
</head>
<body class="con-fondo d-flex flex-column min-vh-100">
  ...
  <?php if ($mensaje): ?>
  <div id="flash" class="toast-flash <?= $mensaje['tipo']==='ok' ? 'toast-ok' : 'toast-error' ?>">
    ...
    <div class="row g-4" style="max-width:900px;margin:0 auto;">
      ...
      <div class="col-12">
        <div class="card p-4">
          ...
          <p class="mb-2">Actual: <strong><?= htmlspecialchars($usuario_actual) ?></strong></p>
...
<div class="col-12">
  <div class="card p-4">
    ...
    <form onsubmit="event.preventDefault(); mostrar_toast('La opción de idioma estará disponible cuando finalicemos la traducción.', 'ok');">
...
<div class="col-12">
  <div class="card p-4 border-danger">
    <h3 class="mb-2 text-danger">CUIDADO</h3>
    <p class="mb-3">
